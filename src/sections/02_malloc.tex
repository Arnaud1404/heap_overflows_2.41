...
répartis en classes espacées de \texttt{0x10}.
...
De plus un chunk rentre dans un fastbin uniquement par le moyen d'un free, autrement
dit lorsqu'une consolidation se produit, le chunk ne peut plus retourner dans
le fastbin et se retrouve donc dans Unsorted ou Smallbin.
